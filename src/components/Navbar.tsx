...
export default function Navbar() {
  ...
  return (
    <>
      {/* Banner de Letreiro (Marquee) no Mobile */}
      <div className="fixed top-0 left-0 w-full z-50 bg-brand-sky text-white h-8 flex items-center overflow-hidden border-b border-brand-sky/10 md:hidden">
        <div className="relative w-full overflow-hidden whitespace-nowrap py-1">
          <div className="inline-block animate-marquee select-none">
            <span className="mx-4 font-sans text-[10px] font-extrabold tracking-[0.2em] uppercase">
      ...
      <nav className="fixed top-8 md:top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-outline transition-all duration-300 h-20 flex items-center">
        ...
        <div 
          className={`fixed inset-0 top-[112px] bg-slate-900/10 backdrop-blur-xs md:hidden z-30 transition-all duration-300 ${
