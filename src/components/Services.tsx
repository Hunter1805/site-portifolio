...
import { MousePointerClick, ShoppingBag, Building2, LayoutGrid, MessageCircle } from 'lucide-react';
  ...
  return (
    <section className="py-20 md:py-32 px-6 bg-gray-50 border-t border-gray-100" id="servicos">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Botão de CTA para WhatsApp — apenas mobile */}
        <div className="mt-14 flex justify-center md:hidden">
          <a
            href="https://wa.me/5538999908770?text=Quero um orçamento"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 text-sm font-semibold text-white bg-green-500 hover:bg-green-600 px-8 py-3.5 rounded-full transition-all duration-200 shadow-lg shadow-green-500/10 active:scale-95 cursor-pointer"
          >
